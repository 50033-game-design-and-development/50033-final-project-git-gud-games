...
If you want to use this asset in a URP, be sure to apply an update to the URP. Go to the Environment VFX pack/Upgrade for URP folder and run "Upgrade for URP".
Important! After updating the asset, any changes made to the Environment VFX pack folder will be lost.
